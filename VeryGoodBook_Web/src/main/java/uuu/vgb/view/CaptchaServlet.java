 ...
 */
//@WebServlet(name="uuu.vgb.view.CaptchaServlet",
//	urlPatterns = {"/images/captcha.png","/images/captcha_register.png" })
public class CaptchaServlet extends HttpServlet {
    ...
    public CaptchaServlet() {
        super();        
        System.out.println("CaptchaServlet 建立了一個物件");//for test
    }
